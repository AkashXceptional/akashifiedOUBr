...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
"`You aren't approved to PM yet. \n\nBeing an unapproved user, you are allowed to send only 3 messages, if you exceed this limit, you will be blocked for spamming this chat `\n\n∆ Message generated by Akash's User Bot ∆ \n")
# =================================================================
        ...
        if event.is_private and event.chat_id != 777000 and event.chat_id != self_user.id and not (
            ...
            if not apprv and event.text != UNAPPROVED_MSG:
                ...
                if COUNT_PM[event.chat_id] > 3:
                    await event.respond(
                        "`You spammed this chat. `\n"
                        "`As a result you have been BLOCKED and reported you as SPAM. `\n\n∆ Action taken by Akash's User Bot ∆"
                    )
...
async def approvepm(apprvpm):
    ...
    try:
        ...
        await apprvpm.edit("`Rejoice! You are approved to PM by Akash.`")
        return

    await apprvpm.edit(f"[{name0}](tg://user?id={uid}) ` is approved to PM by Akash!`")
